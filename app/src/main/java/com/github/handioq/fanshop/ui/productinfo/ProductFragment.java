...
import com.github.handioq.fanshop.ui.productinfo.adapter.InfoAdapter;
import com.github.handioq.fanshop.ui.productinfo.adapter.WrapContentViewPager;
import com.github.handioq.fanshop.ui.productinfo.slider.ImageSliderAdapter;
...
public class ProductFragment extends BaseFragment implements ProductMvp.View, ViewPager.OnPageChangeListener,
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        descriptionPager.setOnTouchListener(new View.OnTouchListener() {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        ...
                        if (distanceY > distanceX && distanceY > dragthreshold) {
                            descriptionPager.getParent().requestDisallowInterceptTouchEvent(false);
                            scrollView.getParent().requestDisallowInterceptTouchEvent(true);
                        } else if (distanceX > distanceY && distanceX > dragthreshold) {
                            descriptionPager.getParent().requestDisallowInterceptTouchEvent(true);
